...
// --- Iran War Campaign (Moved to TOP) ---
const iranWarCampaign = {
  id: 'emergency9',
  title: 'Support iranian war victims',
  description: 'Provide urgent humanitarian aid to families affected by the ongoing conflict. Your donation helps deliver food, shelter, and medical care to those in need',
  fullDescription: 'Civilians affected by the ongoing conflict are facing displacement, injuries, and severe shortages of basic needs. This campaign provides emergency food, shelter and medical care to those in need. Your donation helps save lives and restore hope',
  image: IRAN,
  category: 'emergency',
  raised: 2500,
  goal: 3000000,
...
// Combine all campaigns (Iran War first, then Charlie Kirk, then others)
const allCampaigns = [
  iranWarCampaign, // Iran war campaign at the top
  charlieKirkCampaign, // Charlie Kirk campaign
  ...warCampaigns,
  ...orphansCampaigns,
  ...povertyCampaigns,
  ...educationCampaigns,
